...
public class DeepslateFurnaceMenu extends AbstractContainerMenu {
    ...
    public DeepslateFurnaceMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
    ...
    // CREDIT GOES TO: diesieben07/Kaupenjoe | https://github.com/diesieben07/SevenCommons
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.DEEPSLATE_FURNACE.get());
    }
